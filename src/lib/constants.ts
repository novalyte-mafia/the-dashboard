...
export const CALL_OUTCOMES = [
  ...
  { id: "gatekeeper", label: "Gatekeeper Reached", connected: true, interested: false, color: "amber" },
  { id: "decision_maker_unavailable", label: "Decision-Maker Unavailable", connected: true, interested: false, color: "amber" },
  { id: "decision_maker_reached", label: "Decision-Maker Reached", connected: true, interested: false, color: "teal" },
  { id: "information_provided", label: "Information Provided", connected: true, interested: false, color: "teal" },
  { id: "email_requested", label: "Email Requested / Sent", connected: true, interested: false, color: "teal" },
  { id: "follow_up_required", label: "Follow-Up Required", connected: true, interested: false, color: "amber" },
  ...
  { id: "permission_granted", label: "Approved for Listing", connected: true, interested: true, color: "teal" },
