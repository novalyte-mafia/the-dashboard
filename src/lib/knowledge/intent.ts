...
const INTENT_PATTERNS: Array<{ categories: KnowledgeCategory[]; pattern: RegExp; weight: number }> = [
  ...
  { categories: ["clinic_directory", "compliance"], pattern: /\b(guarantee|guaranteed|how many patients|bring.*patients|patient volume)\b/i, weight: 3 },
  { categories: ["clinic_directory"], pattern: /\b(how.*patients.*find|patients find|directory)\b/i, weight: 2 },
  ...
  { categories: ["objection_handling"], pattern: /\b(advertising|agency|paid|performance|marketplace|workforce|selling something|trying to sell)\b/i, weight: 3 },
