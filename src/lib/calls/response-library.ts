...
export function openingLine(): CopilotResponseBundle {
  return bundle(
    ...
    "Hi, my name's Jamil — I'm the founder of Novalyte AI. We're building a national men's health directory, kind of like a Google for men's health, where patients can find clinics and book right from your profile. Based on our research, yours is exactly the kind of clinic we'd love to feature, and there's no cost. Do you have a quick minute?",
    "Hi, I'm Jamil, founder of Novalyte AI — we run a free national men's health directory where patients find and book clinics. I'd love to feature yours. Got a quick minute?",
    "Pre-call opening: founder intro + free national directory value, permission only.",
  ...
  switch (intent) {
    ...
    case "what_is_novalyte":
      return pick(
        bundle(
          intent,
          "Sure — Novalyte AI is a men's health technology company. We're building a national directory, like a Google for men's health, where patients can find verified clinics and book right from your profile — free for the clinic.",
          "We're a men's health tech company — free national directory where patients find clinics and book from your profile.",
          "Clinic asked what Novalyte is; answer without re-introducing yourself.",
        ),
        bundle(
          intent,
          "We help men find the right men's health clinics. The piece I'm calling about is our free national directory — patients can discover you and book from your profile, no cost to you.",
          "Free national men's health directory — patients find you and book from your profile.",
          "Alternate company description without name re-intro.",
        ),
      );
