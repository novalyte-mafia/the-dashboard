...
const VIEW_TITLES: Record<string, { title: string; sub: string }> = {
  ...
  "campaign-overview": { title: "Campaign Overview", sub: "Organic and paid landing page campaigns" },
  "campaign-wizard": { title: "Campaign Wizard", sub: "Create campaigns and generate pages" },
  "campaign-detail": { title: "Campaign Detail", sub: "Pages, targets, and publish actions" },
  "landing-pages": { title: "Landing Pages", sub: "Campaign Studio page inventory" },
  "page-editor": { title: "Page Editor", sub: "Content, assessment, quality, and publish" },
  "templates": { title: "Templates", sub: "Page layouts and assessment templates" },
  "campaign-analytics": { title: "Campaign Analytics", sub: "Page performance and leads" },
  "campaign-dashboard": { title: "Campaign Overview", sub: "Organic and paid landing page campaigns" },
  "campaign-builder": { title: "Campaign Wizard", sub: "Create campaigns and generate pages" },
  "creative-library": { title: "Templates", sub: "Page layouts and assessment templates" },
  "budget-management": { title: "Campaign Analytics", sub: "Page performance and leads" },
  "lead-attribution": { title: "Campaign Analytics", sub: "Page performance and leads" },
  ...
  "clinic-claims": { title: "Clinic Claims", sub: "Employer clinic claim review" },
  ...
  "live-website-activity": { title: "Live Website Activity", sub: "Visitors, sessions, conversions" },
  "internal-qa-activity": { title: "Internal & QA Activity", sub: "Founder devices and test traffic" },
                ...
                {!query && (
                  <CommandGroup heading="Quick Actions">
                    {[
                      ...
                      { label: "Build Campaign", icon: ShoppingCart, action: () => navigate("campaign-wizard") },
                    ].map((a) => (
